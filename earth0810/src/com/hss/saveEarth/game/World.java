...
import com.hss.savaEarth.Input.KeyEvent;
...
public class World
{
	...
	private void updateRunning(float deltaTime)//hss tag time
	{
	...
	private void increaseDifficulty()//速度增加系数
	{
		difficulty += 0.00005F;
	}
	...
	private void generateNewDot(boolean atStart)
	{
		...
		float linearSpeed;
		if(r>=90||r<=10){
			linearSpeed = 10.0F * difficulty*5;
		}else if(r<90&&r>30){
			linearSpeed = 10.0F * difficulty*3;
		}else{
			linearSpeed = 10.0F * difficulty;
		}
